...
import np.com.rabin.restaurant.RestaurantApp;
import np.com.rabin.restaurant.domain.model.entity.Table;
import np.com.rabin.restaurant.resources.AbstractRestaurantControllerTests;
...
@SpringBootTest(classes = RestaurantApp.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, properties = {
